...
export async function assembleFavoritesList(chatId, text) {
    try {
        ...
        const list = await dbFunctions.fetchFavoritesList(connection, chatId, page)
...
export async function favorite(chatId, text) {
    try {
        ...
        const wordRecord = await await dbFunctions.fetchFirstWord(connection, word)
        ...
        const results = await dbFunctions.setChannelFavorite(connection, chatId, wordId)
...
export async function unfavorite(chatId, text) {
    try {
        ...
        const results = await dbFunctions.deleteChannelFavorite(connection, chatId, wordId)
